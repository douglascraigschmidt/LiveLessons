...
public class Options {
    ...
    protected List<List<URL>> getDefaultResourceUrlList()
        ...
        URL[][] urlsArray = new URL[][] {
            {
            	ClassLoader.getSystemResource("./input/ka.png"),
            	ClassLoader.getSystemResource("./input/uci.png"),
            	ClassLoader.getSystemResource("./input/dougs_small.jpg")
            },
            {    
            	ClassLoader.getSystemResource("./input/ironbound.jpg"),
            	ClassLoader.getSystemResource("./input/wm.jpg"),
            	ClassLoader.getSystemResource("./input/lil_doug.jpg")
            }
        };
