insert into QUOTE (
	...
	('Didn''t KIERKEGAARD wear out his TIRES in VIENNA during a SNOWSTORM of FREUD''s unpaid DENTAL BILLS?'),
	...
	('A KAISER ROLL?!  What good is a Kaiser Roll without a little  COLE SLAW on the SIDE?'),
	('I Know A Joke'),
	...
	('I LOVE juxtaposing th'' splendor of an unpopulated ARROYO with  th'' SLEEK lines of ``NARCISSUS-X'''', my new SPORTS UTILITY VEHICLE!'),
	...
	('.. If I cover this entire WALL with MAZOLA, who I have to give my  AGENT ten per cent??'),
	...
	('Now KEN is having a MENTAL CRISIS because his "R.V." PAYMENTS are  OVER-DUE!!'),
	...
	('OVER the undertow!  UNDER the overpass!  Around the FUTURE  and BEYOND REPAIR!!'),
	...
	('PUMP UP th'' VOLUME!  My BAGEL TOASTER is in tune with th'' UNIVERSAL LIFE  FORCE!!'),
	...
	('Sometimes a TABOO is just a good CIGAR -- or a  rare STEAK -- or a dry MARTINI!'),
	...
	('"THE LITTLE PINK FLESH SISTERS," I saw them at th'' FLUORESCENT BULB  MAKERS CONVENTION...'),
	...
	('This ASIAGO-N-DRIED TOMATO combo would taste a lot better between two  plastic SIPPER LIDS!'),
