...
public class ex32 {
    ...
    /**
     * The number of random {@link Integer} objects to generate.
     */
    private static final long sMAX_INTs = 5;

    /**
     * The lower bound of the randomly generated {@link Integer}
     * objects.
     */
    private static final int sLOWER_BOUND = 1;

    /**
     * The upper bound of the randomly generated {@link Integer}
     * objects.
     */
     ...
     */
    static List<String> concatStream1(List<String> list,
                                      int n) {
    ...
    /**
     * Use the Java Stream {@code mapToObj()} and {@code flatMap()}
     * methods to concatenate the contents of {@code list} together
     * {@code n} times.
     */
    static List<String> concatStream2(List<String> list,
                                      int n) {
        return IntStream
     ...
     */
    static List<String> concatRxJava(List<String> list,
                                     int n) {
        return Observable
