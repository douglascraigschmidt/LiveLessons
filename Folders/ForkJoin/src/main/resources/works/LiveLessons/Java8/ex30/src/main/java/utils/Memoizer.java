 ...
 * the cache.  The cache is implemented using {@code
 * ConcurrentHashMap}, which is correct and efficient in a concurrent
 * program.
 *
...
public class Memoizer<K, V>
    ...
    /**
     * This map atomicially associates a key K with a value V that's
     * produced by a function.
     */
    private final ConcurrentHashMap<K, V> mCache;
