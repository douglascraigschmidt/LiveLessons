...
import static zippyisms.common.Constants.SERVER_CONNECT;
...
public class ZippyConnectController {
    /**
     * The {@link ZippyConnectService} that's associated with this
     * {@link ZippyConnectController} via Spring's dependency
